	...
	plugins: [
		...
		alias({
			entries: [
				...
				{ find: '@definitions', replacement: path.resolve(__dirname, 'src/core/definitions') }
			]
		}),
		...
		rollupPluginInjectProcessEnv({
			local_server: process.env.LOCAL_SERVER
				? "http://localhost:4000/oneff/api/v1"
				: "https://api-global.preprod.decathlon.net/decashop/bff/oneff/api/v1"
		}),
